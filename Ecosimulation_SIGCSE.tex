...
\linespread{0.95} % use to squeeze lines together, if necessary
...
such as Mindstorms~\cite{Mindstorms}, Pico\-Cricket~\cite{Pico}, Finch~\cite{Finch}, and Arduino~\cite{Arduino}
